...
class TaskOrchestrator:
    ...
    def run_task_t6(self, task: Dict) -> None:
        ...
        try:
            ...
            # Get region filter if specified
            nom_region = params.get('nom_region', None)

            # Process by parameter and period
            for param_code in params['code_parametre']:
                for period in params['periods']:
                    date_min, date_max = period.split('/')
                    ...
                    for year in range(start_date.year, end_date.year + 1):
                        ...
                        # Constrain to actual date range
                        ...
                        # Save yearly file if we got results
                        if results:
                            region_suffix = f"_{nom_region}" if nom_region else ""
            ...
            self.logger.info("Task completed", task_id=task_id, records=total_records)
